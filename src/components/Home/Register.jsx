    ...
    <section id="register" className={'flex flex-col ${styles.paddingY} items-center justify-center'}>
      ...
      flex-col relative font-poppins mt-8 text-3xl xxs:mb-2 mb-10 w-full border-b-8 border-[#161616]`}>
        ...
        <div className= {"flex flex-col items-center justify-center absolute sm:mt-10 xxs:mt-6 se:mt-8 mt-6"}>
          <h1 className="text-white font-semibold mx-auto drop-shadow-[0_2px_5px_rgba(255,255,255,0.4)]  
          ...
          xl:text-3xl md:text-2xl sm:text-lg text-sm sm:block hidden drop-shadow-[0_2px_5px_rgba(255,255,255,0.4)] " data-aos="fade-zoom-in" data-aos-duration="700" data-aos-delay-200>
