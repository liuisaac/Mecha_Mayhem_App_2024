...
async function getDriverSkillsScore(teamId) {
  ...
  const apiUrl = `https://www.robotevents.com/api/v2/events/47800/skills?team%5B%5D=${teamId}&type%5B%5D=driver`;
...
async function getProgrammingSkillsScore(teamId) {
  const apiKey = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..hgL4p-6-GzfT1mYzI0Du7RIt9wqNutAsiwafj58kPwfGIY4pHawH-kRgNdqQbLguiO6HrObmQXwBiV5CwLZGX8OCYdr1vl-3SOVrNJqx8Q2f4bjertdymx2SWTcsNpXta2INxQR6hhGlcWD_sAzyicl1u-SI4nMge_XP--e25Va3X5xajdXPYqmpaWWxC54S2r85q4kBLX7dSelYrvAU1dmxqfyW8xakFaDWBVmH_jR_keweiPnqJnF1S80R2peSMoyxa0ncIviY2-Ft7Fi8cuilTKMIkXtbu3l_XPmLUdGcwMfb2-gZMhXU_HO67NReWgV5SEKFMIkLl06nw3j3c6MmdPhgQAgWauqH913UURh-_ok6DYr7_y1tJJIVm8AKaqFHqJ6wbQryNJdHNsw2I_GDSY9Mzge4Np2Rue2Sm4wB0o0vOxbHzB-2P-SCddTSzgcFMPvZP8Am4VZvJZ4Mi8jgfX5XOoUmRs8SxkKNOK9KXlxN3II_XBepw2jeYTYtmt7CEoZmZIZmblZqEsMJzucx9Vm-84INsXiGjn-JA7b37XMMFb1Kv9n_hpdgm7MCRh_TUBV6y0UAYo8SmEdiQPXDAgnVqED72MXeBK1irXMPpZaVBHBWbUJ3zMq36L2NbASyuOTPu467rCakjI6N-N7annfOUJwNooQSDD8S5M0'; 
  const apiUrl = `https://www.robotevents.com/api/v2/events/47800/skills?team%5B%5D=${teamId}&type%5B%5D=programming`;
...
function getTeamAwards(teamId) {
  const apiKey ='eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..hgL4p-6-GzfT1mYzI0Du7RIt9wqNutAsiwafj58kPwfGIY4pHawH-kRgNdqQbLguiO6HrObmQXwBiV5CwLZGX8OCYdr1vl-3SOVrNJqx8Q2f4bjertdymx2SWTcsNpXta2INxQR6hhGlcWD_sAzyicl1u-SI4nMge_XP--e25Va3X5xajdXPYqmpaWWxC54S2r85q4kBLX7dSelYrvAU1dmxqfyW8xakFaDWBVmH_jR_keweiPnqJnF1S80R2peSMoyxa0ncIviY2-Ft7Fi8cuilTKMIkXtbu3l_XPmLUdGcwMfb2-gZMhXU_HO67NReWgV5SEKFMIkLl06nw3j3c6MmdPhgQAgWauqH913UURh-_ok6DYr7_y1tJJIVm8AKaqFHqJ6wbQryNJdHNsw2I_GDSY9Mzge4Np2Rue2Sm4wB0o0vOxbHzB-2P-SCddTSzgcFMPvZP8Am4VZvJZ4Mi8jgfX5XOoUmRs8SxkKNOK9KXlxN3II_XBepw2jeYTYtmt7CEoZmZIZmblZqEsMJzucx9Vm-84INsXiGjn-JA7b37XMMFb1Kv9n_hpdgm7MCRh_TUBV6y0UAYo8SmEdiQPXDAgnVqED72MXeBK1irXMPpZaVBHBWbUJ3zMq36L2NbASyuOTPu467rCakjI6N-N7annfOUJwNooQSDD8S5M0'; // Replace with your Robot Events API key
  const apiUrl = `https://www.robotevents.com/api/v2/events/47800/awards?team%5B%5D=${teamId}`;
