  ...
  return (
    <>
      <div className={`w-full h-full py-2 flex flex-row justify-start items-center 
          ...
          transition duration-100 ease-in-out group ${Toggle?"border-r-4 border-r-red-500":"visible"}`} 
           onClick={()=>setToggle(!Toggle)}>

        <div className={`w-12 ml-${add(parseInt(shift), 4)} opacity-60 transition duration-200 ease-in-out group-hover:opacity-100`}><img src={icon} /></div>
