...
const Info = () => {
    return (
        <div className="bg-black w-screen flex flex-row justify-center items-center overflow-clip">
            <div className="w-[80vw]">
                <ImageFlipper />

                <div className="relative mt-10 bg-black">
                    <h1 className="text-white sm:text-[88px] text-6xl leading-[1.2] mt-12 pt-8 font-poppins">
                        Canada's{" "}
                        <span
                    ...
                    <p className="sm:w-1/2 w-full text-white text-xl mt-8">
                        Started in 2023, Mecha Mayhem brings together over{" "}
                        <span className="font-rubik font-bold text-red-500">
                            160
                        </span>{" "}
                        High school and Middle school teams from around the
                        world to compete at the BMO Centre for{" "}
                        <span className="font-rubik font-bold text-red-500">
                            three full days
                        </span>{" "}
                        ...
                        cheer on the teams, and chat with local tech companies
                        and universities! In addition, we will be giving tours
                        on how to start your own robotics team at your school or
                        through our club!
                    </p>
                    ...
                    <div className="mt-16">
                        ...
                        <p className="text-white text-xl mt-2 sm:w-3/4 w-full">
                            VEX is an international robotics organization that
                            supplies the tools and parts necessary for students
                            to create and program robots. It is the largest
                            robotics competition in the world, with{" "}
                            <span className="font-rubik font-bold text-red-500">
                                more than a million{" "}
                            </span>
                    ...
                    <div className="py-16">
                        ...
                        <p className="text-white text-xl mt-2 sm:w-3/4 w-full">
                            Signature Events give teams the opportunity to play
                            at a tournament that is of the{" "}
                            <span className="font-rubik font-bold text-red-500">
                                highest caliber
                            </span>
                            . The mission of these events is to provide more
                            opportunities for teams that do not typically attend
                            Event Regional Championships or the World
                            Championship to experience an event above and beyond
                            a standard tournament. Signature Events also have
                            the added bonus of qualifying teams directly to{" "}
                            <span className="font-rubik font-bold text-red-500">
